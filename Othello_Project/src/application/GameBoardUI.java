...
/**
 * UI for the othello board, also handles pass/quit buttons
 *
 * Authors (In order of contribution): Jason McElwee, Thomas King, Aston Jones
 */
public class GameBoardUI {
    ...
    public static void showResult() {
        ...
        if (game.getGameBoard().timeUp) {
            ...
            !game.getGameBoard().resigned &&
            game.getGameBoard().getWhiteScore() +
            game.getGameBoard().getBlackScore() <
            64
        ) {
